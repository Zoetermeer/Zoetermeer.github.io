...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aD: 'hidden', E: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aD: 'mozHidden', E: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aD: 'msHidden', E: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aD: 'webkitHidden', E: 'webkitvisibilitychange' }
		: { aD: 'hidden', E: 'visibilitychange' };
}
...
var author$project$Main$Team = F4(
	function (city, fullName, nickname, logoUrl) {
		return {Z: city, aC: fullName, R: logoUrl, ag: nickname};
	});
...
var author$project$Main$init = function (_n0) {
	...
	var mtModel = {h: 0, m: 0, D: author$project$Main$defaultAway, M: 0, i: 0, n: 0, F: author$project$Main$defaultHome, N: 1, O: teamArray};
...
var author$project$Main$selectTeam = F3(
	function (model, getNewIndex, getCurIndex) {
		var i = A2(
			...
			model.O,
			getCurIndex(model));
		var newTeam = A2(elm$core$Array$get, i, model.O);
		if (newTeam.$ === 1) {
		...
		switch (msg.$) {
			case 6:
				...
				var homePPMs = A2(
					elm$core$Basics$max,
					0,
					model.i - elm$core$Basics$round(author$project$Main$tickInterval));
				var awayPPMs = A2(
					elm$core$Basics$max,
					0,
					model.h - elm$core$Basics$round(author$project$Main$tickInterval));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{h: awayPPMs, i: homePPMs}),
				...
				return author$project$Main$withNoCmd(
					function () {
						if (!tp) {
							return _Utils_update(
								model,
								{i: author$project$Main$powerPlayDurationMs});
						} else {
							return _Utils_update(
								model,
								{h: author$project$Main$powerPlayDurationMs});
						}
					}());
			default:
				var tp = msg.a;
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							elm$core$String$toUpper(team.Z))
						])),
					A2(elm$html$Html$br, _List_Nil, _List_Nil),
					elm$html$Html$text(
					elm$core$String$toUpper(team.ag))
				]));
	});
...
var author$project$Main$mainTable = function (model) {
	var isHomePP = model.i > 0;
	var isAwayPP = model.h > 0;
	var homePPMsg = isHomePP ? author$project$Main$StopPowerPlay(0) : author$project$Main$StartPowerPlay(0);
	var awayPPMsg = isAwayPP ? author$project$Main$StopPowerPlay(1) : author$project$Main$StartPowerPlay(1);
	var _n0 = _Utils_eq(model.m, model.n) ? _Utils_Tuple2('', '') : ((_Utils_cmp(model.m, model.n) > 0) ? _Utils_Tuple2('glow', '') : _Utils_Tuple2('', 'glow'));
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Main$NextTeam(1)),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('noselect'),
										elm$html$Html$Attributes$src(model.D.R),
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$align('center'),
								elm$html$Html$Events$onClick(
								author$project$Main$NextTeam(0)),
								elm$html$Html$Attributes$class('noselect'),
								A2(elm$html$Html$Attributes$style, 'width', '50%')
							]),
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$src(model.F.R),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2(author$project$Main$teamNameDiv, isAwayPP, model.D)
							])),
						A2(
						elm$html$Html$td,
						_List_fromArray(
						...
						_List_fromArray(
							[
								A2(author$project$Main$teamNameDiv, isHomePP, model.F)
							]))
					])),
				A2(
				elm$html$Html$tr,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$Main$IncrScore(1)),
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$Main$IncrScore(0)),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2(author$project$Main$powerPlayButton, model.h, awayPPMsg)
							])),
						A2(
						elm$html$Html$td,
						_List_fromArray(
						...
						_List_fromArray(
							[
								A2(author$project$Main$powerPlayButton, model.i, homePPMsg)
							]))
					])),
				A2(
				elm$html$Html$tr,
