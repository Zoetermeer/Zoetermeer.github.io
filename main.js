...
var author$project$Main$defaultAway = A4(author$project$Main$Team, 'Arizona', 'Arizona Coyotes', 'Coyotes', 'assets/images/arizona-coyotes.svg');
var author$project$Main$defaultHome = A4(author$project$Main$Team, 'Anaheim', 'Anaheim Ducks', 'Ducks', 'assets/images/anaheim-ducks.svg');
...
var author$project$Main$allTeams = _List_fromArray(
	[
		author$project$Main$defaultHome,
		author$project$Main$defaultAway,
		...
		A4(author$project$Main$Team, 'Glacier', 'Glacier Ice Dogs', 'Ice Dogs', 'assets/images/glacier-ice-dogs.png'),
		...
		A4(author$project$Main$Team, 'Northwest', 'Northwest Chargers', 'Chargers', 'assets/images/northwest-chargers.png'),
		...
		A4(author$project$Main$Team, 'Arizona', 'Arizona Diamondbacks', 'Diamondbacks', 'assets/images/arizona-diamondbacks.svg'),
		A4(author$project$Main$Team, 'Atlanta', 'Atlanta Braves', 'Braves', 'assets/images/atlanta-braves.svg'),
		A4(author$project$Main$Team, 'Baltimore', 'Baltimore Orioles', 'Orioles', 'assets/images/baltimore-orioles.svg'),
		A4(author$project$Main$Team, 'Boston', 'Boston Red Sox', 'Red Sox', 'assets/images/boston-red-sox.svg'),
		...
		A4(author$project$Main$Team, 'Cincinnati', 'Cincinnati Reds', 'Reds', 'assets/images/cincinnati-reds.svg'),
		A4(author$project$Main$Team, 'Cleveland', 'Cleveland Indians', 'Indians', 'assets/images/cleveland-indians.svg'),
		A4(author$project$Main$Team, 'Colorado', 'Colorado Rockies', 'Rockies', 'assets/images/colorado-rockies.svg'),
		A4(author$project$Main$Team, 'Detroit', 'Detroit Tigers', 'Tigers', 'assets/images/detroit-tigers.svg'),
		A4(author$project$Main$Team, 'Houston', 'Houston Astros', 'Astros', 'assets/images/houston-astros.svg'),
		A4(author$project$Main$Team, 'Kansas City', 'Kansas City Royals', 'Royals', 'assets/images/kc-royals.svg'),
		A4(author$project$Main$Team, 'Los Angeles', 'Los Angeles Angels', 'Angels', 'assets/images/la-angels.svg'),
		A4(author$project$Main$Team, 'Los Angeles', 'Los Angeles Dodgers', 'Dodgers', 'assets/images/la-dodgers.svg'),
		A4(author$project$Main$Team, 'Miami', 'Miami Marlins', 'Marlins', 'assets/images/miami-marlins.svg'),
		A4(author$project$Main$Team, 'Milwaukee', 'Milwaukee Brewers', 'Brewers', 'assets/images/milwaukee-brewers.svg'),
		A4(author$project$Main$Team, 'Minnesota', 'Minnesota Twins', 'Twins', 'assets/images/minnesota-twins.svg'),
		...
		A4(author$project$Main$Team, 'Philadelphia', 'Philadelphia Phillies', 'Phillies', 'assets/images/philadelphia-phillies.svg'),
		A4(author$project$Main$Team, 'Pittsburgh', 'Pittsburgh Pirates', 'Pirates', 'assets/images/pittsburgh-pirates.svg'),
		A4(author$project$Main$Team, 'San Francisco', 'San Francisco Giants', 'Giants', 'assets/images/sf-giants.svg'),
		A4(author$project$Main$Team, 'San Diego', 'San Diego Padres', 'Padres', 'assets/images/san-diego-padres.svg'),
		A4(author$project$Main$Team, 'Seattle', 'Seattle Mariners', 'Mariners', 'assets/images/seattle-mariners.svg'),
		A4(author$project$Main$Team, 'St. Louis', 'St. Louis Cardinals', 'Cardinals', 'assets/images/st-louis-cardinals.svg'),
		A4(author$project$Main$Team, 'Tampa Bay', 'Tampa Bay Rays', 'Rays', 'assets/images/tb-rays.svg'),
		A4(author$project$Main$Team, 'Texas', 'Texas Rangers', 'Rangers', 'assets/images/texas-rangers.svg'),
		A4(author$project$Main$Team, 'Toronto', 'Toronto Blue Jays', 'Blue Jays', 'assets/images/toronto-blue-jays.svg'),
		A4(author$project$Main$Team, 'Washington', 'Washington Nationals', 'Nationals', 'assets/images/washington-nationals.svg'),
		...
		A4(author$project$Main$Team, 'Los Angeles', 'Los Angeles Rams', 'Rams', 'assets/images/los-angeles-rams.svg'),
		A4(author$project$Main$Team, 'Minnesota', 'Minnesota Vikings', 'Vikings', 'assets/images/minnesota-vikings.svg'),
		A4(author$project$Main$Team, 'New England', 'New England Patriots', 'Patriots', 'assets/images/new-england-patriots.svg'),
...
var author$project$Main$init = function (_n0) {
	...
	var mtModel = {awayPowerPlayMs: 0, awayScore: 0, awayTeam: author$project$Main$defaultAway, awayTeamIndex: 0, homePowerPlayMs: 0, homeScore: 0, homeTeam: author$project$Main$defaultHome, homeTeamIndex: 1, teams: teamArray};
	return _Utils_Tuple2(mtModel, elm$core$Platform$Cmd$none);
};
var author$project$Main$Tick = function (a) {
	return {$: 'Tick', a: a};
};
var author$project$Main$tickInterval = 10;
...
var author$project$Main$subscriptions = function (_n0) {
	return A2(elm$time$Time$every, author$project$Main$tickInterval, author$project$Main$Tick);
};
...
var author$project$Main$nextIndex = F2(
	function (xs, curInd) {
		return _Utils_eq(
			curInd,
			elm$core$Array$length(xs) - 1) ? 0 : (curInd + 1);
	});
var author$project$Main$powerPlayDurationMs = (2 * 60) * 1000;
...
var author$project$Main$selectTeam = F3(
	function (model, getNewIndex, getCurIndex) {
		var i = A2(
			...
			model.teams,
			getCurIndex(model));
		var newTeam = A2(elm$core$Array$get, i, model.teams);
		if (newTeam.$ === 'Nothing') {
			return _Utils_Tuple2(0, author$project$Main$defaultHome);
		} else {
			var team = newTeam.a;
			return _Utils_Tuple2(i, team);
		}
	});
		...
		switch (msg.$) {
			case 'Tick':
				...
				var homePPMs = A2(
					elm$core$Basics$max,
					0,
					model.homePowerPlayMs - elm$core$Basics$round(author$project$Main$tickInterval));
				var awayPPMs = A2(
					elm$core$Basics$max,
					0,
					model.awayPowerPlayMs - elm$core$Basics$round(author$project$Main$tickInterval));
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var author$project$Main$decrButton = F2(
	function (msg, attrs) {
		return A2(
			elm$html$Html$div,
			_Utils_ap(
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('btn subtract-button noselect'),
...
var author$project$Main$toDurationStr = function (ms) {
	var sec = ((ms % 60000) / 1000) | 0;
	var min = (((ms / 1000) | 0) / 60) | 0;
	var hms = ((ms % 1000) / 10) | 0;
	return author$project$Main$padNum(min) + (':' + (author$project$Main$padNum(sec) + ('.' + author$project$Main$padNum(hms))));
};
var elm$html$Html$Attributes$align = elm$html$Html$Attributes$stringProperty('align');
var author$project$Main$powerPlayButton = F2(
	function (msLeft, msg) {
		return (msLeft > 0) ? A2(
			elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					'POWER PLAY ' + author$project$Main$toDurationStr(msLeft))
				])) : A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								elm$core$String$fromInt(model.awayScore))
							])),
						A2(
						elm$html$Html$td,
						_List_fromArray(
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								elm$core$String$fromInt(model.homeScore))
							]))
					])),
				A2(
				elm$html$Html$tr,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2(author$project$Main$powerPlayButton, model.awayPowerPlayMs, awayPPMsg)
							])),
						A2(
						elm$html$Html$td,
						_List_fromArray(
