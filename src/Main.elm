...
view model =
    div [ class "scoreboard" ]
        [ div [ onClick NextAwayTeam, class "btn noselect", align "center", gridRow 1, gridColSpan 1 4 ] [ img [ src model.awayTeam.logoUrl, height 150 ] [] ]
        , div [ onClick NextHomeTeam, class "btn noselect", align "center", gridRow 1, gridColSpan 4 7 ] [ img [ src model.homeTeam.logoUrl ] [] ]
        , div [ align "center", gridRow 2, gridCol 2 ] [ text model.awayTeam.fullName ]
        , div [ align "center", gridRow 2, gridCol 5 ] [ text model.homeTeam.fullName ]
        , h1 [ onClick IncrAwayScore, class "btn noselect", align "center", class "scoreboard-text large-font", gridRow 3, gridColSpan 1 4 ] [ text (Debug.toString model.awayScore) ]       
